		...
		if (global.Boss_Health == 0) {
			...
			switch (currentAttack)
			{
				...
				case 2: //summon saws vertically and make them move across the screen
					...
					break;
				case 3: //change sprite lunge straight forward and go off the screen then return back from the top of the screen
					
					if (place_meeting(x , y + moveSpeed , BossStopperWall)){ 
						//possibly replace with a if boss is at certain x cord and then make it stop moving
						y = y + moveSpeed;
						moveSpeed = false;
